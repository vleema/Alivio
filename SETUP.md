...
```bash
git clone https://github.com/rutgers-apl/Alivio.git
cd alivio
cargo build --release
```
...
wget -O ~/BCF/output/bzImage \
    https://github.com/rutgers-apl/Alivio/releases/download/kernel-47b3934f7ad8/bzImage
...
wget -O /tmp/libbpf-alivio.tar.gz \
    https://github.com/rutgers-apl/Alivio/releases/download/kernel-47b3934f7ad8/libbpf-alivio.tar.gz
